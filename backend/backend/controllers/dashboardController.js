...
module.exports = {
  ...
  getCelebrations: async (req, res) => {
    try {
      ...
      console.log(`Dashboard: Fetching celebrations for ${today.toDateString()} (Month: ${currentMonth}, Date: ${currentDate})`);
      ...
      console.log(`Dashboard: Found ${todayBirthdays.length} today birthdays, ${todayAnniversaries.length} today anniversaries, ${upcomingBirthdays.length} upcoming birthdays, ${upcomingAnniversaries.length} upcoming anniversaries`);
