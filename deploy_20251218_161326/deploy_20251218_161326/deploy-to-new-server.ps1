...
$excludeDirs = @("node_modules", ".git", "dist", "uploads")
...
Get-ChildItem -Path "." -Recurse | Where-Object {
    ...
    -not $exclude -and $item.Name -notlike "*.log" -and $item.Name -notlike "backup_*.sql"
} | ForEach-Object {
...
Write-Host "Step 4: Creating archive..." -ForegroundColor Yellow
