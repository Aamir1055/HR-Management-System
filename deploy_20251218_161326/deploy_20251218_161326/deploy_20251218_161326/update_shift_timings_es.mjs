...
// Database connection configuration - trying both database names
const dbConfig = {
  host: 'localhost',
  user: 'root',
  password: '',
  database: 'payroll_system2' // Updated based on .env file
};
...
async function updateShiftTimings() {
  ...
  try {
    ...
    rows.forEach(employee => {
      console.log(`ID: ${employee.id}, Employee ID: ${employee.employeeId}, Name: ${employee.name}, Email: ${employee.email}, Current Shift: ${employee.shift_timings || 'NULL'}`);
    });
